...
public class FastDeflater {
    ...
    private final com.bluedevel.zlib.ZStreamRef zsRef;
    ...
    static {
        System.load("/Users/kireet/.m2/repository/com/bluedevel/fastzlib-dylib/1.0-SNAPSHOT/fastzlib-dylib-1.0-SNAPSHOT.dylib");
        initIDs("libz.dylib");
    }
    ...
    public FastDeflater(int level, boolean nowrap) {
        ...
        this.zsRef = new com.bluedevel.zlib.ZStreamRef(init(level, DEFAULT_STRATEGY, nowrap));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        FastDeflaterOutputStream ostream = new com.bluedevel.zlib.FastDeflaterOutputStream(bos, def);
